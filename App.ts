...
// Google expects the verifier and challenge in URL-safe base64 without padding. 
// This conversion works directly with browser-generated bytes.
const toBase64Url = (bytes: Uint8Array): string => { // toBase64Url is 
    let binary = '';
    bytes.forEach((byte) => {
